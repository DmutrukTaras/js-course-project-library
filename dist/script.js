...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.dropdown = function () {
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(`[data-toggle-id="${id}"]`).fadeToggle(400);
    });
  }
};
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.tab = function (content) {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.addAttribute = function (attrName, attrValue) {
...
$('#modalTriger').click(() => {
  $('#modalTriger').createModal({
    ...
    btns: {
      count: 3,
      settings: [['Close', ['btn-danger', 'mb-10', 'w-50'], true], ['Save changes', ['btn-success', 'mb-10', 'w-50'], false, () => {
        console.log('btn-success');
      }], ['One more btn', ['btn-warning', 'mt-20', 'd-block', 'w-100'], false, () => {
